...
Mon.renderCards = function(cid, L) {
    ...
    var items = [
        ...
        {k:'mem_percent',   lb:'RAM Used',  vl:Math.round(L.mem_percent)+'%', dt:'Free '+rf+' GiB', cl:'#bc8cff', cls:'', w:L.mem_percent>85, c:L.mem_percent>85},
        {k:'disk_root',     lb:'Disk /',    vl:Math.round(L.disk_root)+'%', dt:rootGb+' GiB SSD', cl:'#a5d6ff', cls:'', w:L.disk_root>85, c:L.disk_root>85},
