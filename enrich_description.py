...
Инструменты: get_persona_info, get_folder_context, get_nearby_photos — вызывай если нужно уточнить.
...
Не придумывай факты. Только из описания и данных.
Кратко, 2-3 предложения. Без воды."""
